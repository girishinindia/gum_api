-- ══════════════════════════════════════════════════════════════════════════════
-- FUNCTION: udf_category_translations_delete
-- PURPOSE:  Soft-delete a single category translation.
-- RETURNS:  JSONB { success, message }
-- ══════════════════════════════════════════════════════════════════════════════

CREATE OR REPLACE FUNCTION udf_category_translations_delete(
    p_id BIGINT
)
RETURNS JSONB
LANGUAGE plpgsql
...
-- SELECT * FROM udf_category_translations_delete(p_id := 1);
