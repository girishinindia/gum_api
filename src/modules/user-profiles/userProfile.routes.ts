...
r.put('/me',  upload.fields([{ name: 'profile_image', maxCount: 1 }, { name: 'cover_image', maxCount: 1 }]), coerceNullStrings, ctrl.updateMyProfile);
...
r.put('/user/:userId',                    requirePermission('user_profile', 'update'), upload.fields([{ name: 'profile_image', maxCount: 1 }, { name: 'cover_image', maxCount: 1 }]), coerceNullStrings, ctrl.upsert);
