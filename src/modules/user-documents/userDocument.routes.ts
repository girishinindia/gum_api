...
r.post('/me', upload.single('file'), coerceNullStrings,              ctrl.createMy);
r.patch('/me/:id', upload.single('file'), coerceNullStrings,          ctrl.updateMy);
...
r.post('/', upload.single('file'), coerceNullStrings,                  requirePermission('user_document', 'create'), ctrl.create);
r.patch('/:id', upload.single('file'), coerceNullStrings,              requirePermission('user_document', 'update'), ctrl.update);
