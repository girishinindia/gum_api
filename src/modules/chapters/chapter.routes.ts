...
r.post('/',                requirePermission('chapter', 'create'),      validate(createChapterSchema), ctrl.create);
r.patch('/:id/restore',   requirePermission('chapter', 'restore'),     ctrl.restore);
r.patch('/:id',           requirePermission('chapter', 'update'),      validate(updateChapterSchema), ctrl.update);
