...
r.post('/',                requirePermission('designation', 'create'),      validate(createDesignationSchema), ctrl.create);
r.patch('/:id/restore',   requirePermission('designation', 'restore'),     ctrl.restore);
r.patch('/:id',           requirePermission('designation', 'update'),      validate(updateDesignationSchema), ctrl.update);
