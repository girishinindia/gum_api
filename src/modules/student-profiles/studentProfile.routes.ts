...
r.get('/user/:userId', requirePermissionOrOwn('student_profile', 'read'), ctrl.getByUserId);
r.put('/user/:userId', requirePermissionOrOwn('student_profile', 'update'), ctrl.upsertByUserId);

// ── Admin CRUD ──
r.get('/', requirePermission('student_profile', 'read'), ctrl.list);
r.post('/', requirePermission('student_profile', 'create'), ctrl.create);
r.get('/:id', requirePermission('student_profile', 'read'), ctrl.getById);
