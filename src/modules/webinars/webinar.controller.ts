...
export async function list(req: Request, res: Response) {
  ...
  if (search) q = (await applyTranslatedSearch(q, supabase, {
    search,
    base: ['title', 'code'],
    translation: { table: 'webinar_translations', fk: 'webinar_id', cols: ['title'] },
  ...
  else if (req.query.show_deleted !== 'true') q = q.neq('webinar_status', 'cancelled'); // hide cancelled by default (Trash shows all)
