...
r.post('/',                requirePermission('subject', 'create'),      validate(createSubjectSchema), ctrl.create);
r.patch('/:id/restore',   requirePermission('subject', 'restore'),     ctrl.restore);
r.patch('/:id',           requirePermission('subject', 'update'),      validate(updateSubjectSchema), ctrl.update);
