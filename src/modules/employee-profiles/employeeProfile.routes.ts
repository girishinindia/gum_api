...
r.get('/user/:userId', requirePermissionOrOwn('employee_profile', 'read'), ctrl.getByUserId);
r.put('/user/:userId', requirePermissionOrOwn('employee_profile', 'update'), ctrl.upsertByUserId);

// ── Admin CRUD ──
r.get('/', requirePermission('employee_profile', 'read'), ctrl.list);
r.post('/', requirePermission('employee_profile', 'create'), ctrl.create);
r.get('/:id', requirePermission('employee_profile', 'read'), ctrl.getById);
