...
import { upload, coerceNullStrings } from '../../middleware/upload';
...
r.post('/me', upload.single('certificate'), coerceNullStrings,           ctrl.createMyEducation);
r.patch('/me/:id', upload.single('certificate'), coerceNullStrings,      ctrl.updateMyEducation);
...
r.post('/', upload.single('certificate'), coerceNullStrings,  requirePermission('user_education', 'create'), ctrl.create);
r.patch('/:id', upload.single('certificate'), coerceNullStrings, requirePermission('user_education', 'update'), ctrl.update);
