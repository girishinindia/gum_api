...
r.post('/',                requirePermission('state', 'create'),      validate(createStateSchema), ctrl.create);
r.patch('/:id/restore',   requirePermission('state', 'restore'),     ctrl.restore);
r.patch('/:id',           requirePermission('state', 'update'),      validate(updateStateSchema), ctrl.update);
