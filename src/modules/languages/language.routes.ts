...
import { createLanguageSchema, updateLanguageSchema } from './language.schema';
...
r.post('/',                requirePermission('language', 'create'),      validate(createLanguageSchema), ctrl.create);
r.patch('/:id/restore',   requirePermission('language', 'restore'),     ctrl.restore);
r.patch('/:id',           requirePermission('language', 'update'),      validate(updateLanguageSchema), ctrl.update);
