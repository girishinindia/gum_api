...
import teamMemberRoutes from './modules/team-members/teamMember.routes';
import jobPositionRoutes from './modules/job-positions/jobPosition.routes';
import jobApplicationRoutes from './modules/job-applications/jobApplication.routes';
import contactEnquiryRoutes from './modules/contact-enquiries/contactEnquiry.routes';
import aboutPageRoutes from './modules/about-page/aboutPage.routes';
import homePageRoutes from './modules/home-page/homePage.routes';
...
import chatAttachmentRoutes from './modules/chat-attachments/chatAttachment.routes';
